...
def home(request):
    ...
    return render(request,'neigh_app/index.html',{"all_posts":all_posts,"prof_info":profile,"hoodie":hoodie})
...
def contact(request):
    ...
    return render(request,'neigh_app/contact_info.html',{"contacts":contacts})
